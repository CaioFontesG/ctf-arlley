...
_FLAG_VARS = [
    "FLAG_RECONHECIMENTO",   # 1
    "FLAG_ENUMERACAO",       # 2
    "FLAG_CREDENCIAIS",      # 3
    "FLAG_VALIDACAO_FRONT",  # 4  ← inserido entre 3 e 4
    "FLAG_DEVTOOLS",         # 5
    "FLAG_HEADER",           # 6
    "FLAG_FUZZING",          # 7
    "FLAG_LFI",              # 8
    "FLAG_SQL_INJECTION",    # 9
    "FLAG_UPLOAD",           # 10
    "FLAG_CADEIA",           # 11
]
...
CHALLENGES = [
    ...
    },
    {
        ...
        "description": (
            ...
            f"Acesse o desafio: [{BASE_URL}/chall-06/]({BASE_URL}/chall-06/)\n\n"
    ...
    },
    {
        ...
        "category": "Web",
        "description": (
            f"O endpoint `/terms?doc=` lê arquivos do servidor sem validar o caminho informado.\n\n"
